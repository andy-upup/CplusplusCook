...
static int ComputeSumOrdInt(const int x, const int y) { return x + y; }
...
int FunctionSum(const int x, const int y) {
  ...
  std::cout << "Sum of " << x << " and " << y << " is: " << tem_sum
            << std::endl;
  return sum;
}
...
int FunctionSumLambda(const int x, const int y) {
  auto compute_sum = [](const int x, const int y) { return x + y; };
...
int FunctionSumClass(const int x, const int y) {
  ...
  std::function<float(Functor&, float, float)> tem_func1 =
      &Functor::ComputeSumTem<float>;
  std::function<float(Functor, float, float)> tem_func2 =
      &Functor::ComputeSumTem<float>;
  ...
  std::function<float(float, float)> st_tem_func =
      Functor::ComputeSumStTem<float>;
  ...
  std::cout << "Sum of " << x << " and " << y << " is: " << tem_sum1
            << std::endl;
  std::cout << "Sum of " << x << " and " << y << " is: " << tem_sum2
            << std::endl;
  std::cout << "Sum of " << x << " and " << y << " is: " << st_sum << std::endl;
  std::cout << "Sum of " << x << " and " << y << " is: " << st_tem_sum
            << std::endl;
  return sum1;
}
...
int FunctionSumClassBind(const int x, const int y) {
  FunctorBind functor;
  std::function<int(int, int)> pointer_func =
      std::bind(&FunctorBind::ComputeSumInt, &functor, std::placeholders::_1,
                std::placeholders::_2);
  std::function<int(int, int)> object_func =
      std::bind(&FunctorBind::ComputeSumInt, functor, std::placeholders::_1,
                std::placeholders::_2);
  std::function<int(int, int)> st_func =
      std::bind(FunctorBind::ComputeSumStInt, std::placeholders::_1,
                std::placeholders::_2);
  std::function<int(int, int)> tem_func =
      std::bind(&FunctorBind::ComputeSumTem<int>, &functor,
  ...
  std::cout << __func__ << std::endl;
  std::cout << "Sum of " << x << " and " << y << " is: " << pointer_sum
            << std::endl;
  std::cout << "Sum of " << x << " and " << y << " is: " << object_sum
            << std::endl;
  std::cout << "Sum of " << x << " and " << y << " is: " << st_sum << std::endl;
  std::cout << "Sum of " << x << " and " << y << " is: " << tem_sum
            << std::endl;
