...
void TestMaxHeap(std::vector<int>& vec) {
    ...
    std::cout << "After push, max value of initial vec is: " << vec.front() << std::endl;
    return;
}
...
void TestMinHeap(std::vector<int>& vec) {
    ...
    std::cout << "After push, min value of initial vec is: " << vec.front() << std::endl;
...
void TestMaxHeap(std::vector<std::pair<int, int>>& vec) {
    ...
    std::make_heap(vec.begin(), vec.end(), cmp);
    std::cout << "Max value of initial vec is: " <<
        vec.front().first << ": " << vec.front().second << std::endl;

    std::pop_heap(vec.begin(), vec.end(), cmp);
    std::cout << "After pop, max value of initial vec is: " <<
        vec.front().first << ": " << vec.front().second << std::endl;
}
