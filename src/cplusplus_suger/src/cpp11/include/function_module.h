...
class Functor {
 public:
  int ComputeSumInt(int x, int y) { return x + y; }
  static int ComputeSumStInt(const int x, const int y) { return x + y; }
  template <typename T>
...
class FunctorBind {
 public:
  int ComputeSumInt(const int x, const int y) { return x + y; }
  static int ComputeSumStInt(const int x, const int y) { return x + y; }
  template <typename T>
  T ComputeSumTem(T x, T y) {
    return x + y;
